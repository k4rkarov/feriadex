...
export const ptBR = {
  ...
  "recents.heading": "Estudos recentes",
  "recents.national": "Nacional",
  "recents.remove": "Remover",
  "heatmap.show": "Ver mapa de calor",
  "heatmap.hide": "Ver plano escolhido",
  "heatmap.heading": "Mapa de calor — blocos de",
  "heatmap.days": " dias",
  "heatmap.restDays": "dias de descanso",
  "heatmap.legendLow": "menos eficiente",
  "heatmap.legendHigh": "mais eficiente",
  "export.googleCalendar": "Adicionar ao Google Calendar",
  "export.ics": "Baixar .ics",
  "export.eventTitle": "Férias — Período",
